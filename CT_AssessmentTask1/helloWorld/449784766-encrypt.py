#Program takes a message and encrypts it using ceaser cipher. Takes the info from a file and puts it into a new file that it creates.
...
except FileNotFoundError: #in case code has error
